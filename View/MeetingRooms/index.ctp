<div class="meetingRooms index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $meetingRoom['MeetingRoom']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $meetingRoom['MeetingRoom']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
